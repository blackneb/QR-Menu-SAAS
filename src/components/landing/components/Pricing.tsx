...
import Standard from "../public/assets/Standard.png"
        ...
        <div className="flex flex-col w-full my-16" id="testimoni">
          ...
          <ScrollAnimationWrapper className="relative w-full mt-16">
            <motion.div variants={scrollAnimation} custom={{duration: 3}}>
              <div className="absolute bg-white rounded-xl  py-8 sm:py-14 px-6 sm:px-12 lg:px-16 w-full flex flex-col sm:flex-row justify-between items-center z-10 bg-white-500">
